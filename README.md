<div align="center">
  <img src="assets/banner.png" width="100%" alt="OF-CODE Banner">
...
```mermaid
graph TD
    A["Oflu Ruhu (Öz)"] --> B{"Kurumsal Temeller"}
    B --> C["İlim ve İcazet (Zihin)"]
    B --> D["Siyaset ve Ankara (Güç)"]
    B --> E["Direniş ve Toprak (İrade)"]
    
    C --> F["Müderrisler & Savtul-Kur'an"]
    D --> G["Bürokrasi & Karar Mekanizmaları"]
    E --> H["Baltacı Deresi Stratejik Müdafaası"]
    
    F & G & H --> I["Kolektif Oflu Otoritesi"]
    I --> J["Global Ölçekte Of Etkisi"]
    J --> K["OF-CODE Dijital Mirası"]
```
...
<div align="center">
  ...
  <p><i>Otorite ve İrade Arşivi - Milli Hafıza ve Kültür Merkezi - 2026</i></p>
</div>
